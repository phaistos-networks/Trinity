...
static bool same(const exec_node &a, const exec_node &b) noexcept
{
        ...
        {
                const auto *const __restrict__ runa = (compilation_ctx::termsrun *)a.ptr;
                const auto *const __restrict__ runb = (compilation_ctx::termsrun *)b.ptr;
        ...
        {
                const auto *const __restrict__ pa = (compilation_ctx::phrase *)a.ptr;
                const auto *const __restrict__ pb = (compilation_ctx::phrase *)b.ptr;
...
static exec_node compile_node(const ast_node *const n, compilation_ctx &cctx, simple_allocator &a)
{
        ...
        switch (n->type)
        {
                ...
                case ast_node::Type::MatchSome:
                        ...
                        {
                                auto pm = (compilation_ctx::partial_match_ctx *)a.Alloc(sizeof(compilation_ctx::partial_match_ctx) + sizeof(exec_node) * n->match_some.size);
...
static void collapse_node(exec_node &n, compilation_ctx &cctx, simple_allocator &a, std::vector<exec_term_id_t> &terms, std::vector<const compilation_ctx::phrase *> &phrases, std::vector<exec_node> &stack)
{
        ...
        else if (n.fp == ENT::logicaland || n.fp == ENT::logicalor || n.fp == ENT::logicalnot)
        {
                ...
                if (n.fp == ENT::logicaland)
                {
                        ...
                        if ((ctx->lhs.fp == ENT::matchterm || ctx->lhs.fp == ENT::matchphrase || ctx->lhs.fp == ENT::SPECIALIMPL_COLLECTION_LOGICALAND) && ctx->rhs.fp == ENT::logicaland && ((otherCtx = (compilation_ctx::binop_ctx *)ctx->rhs.ptr)->lhs.fp == ENT::matchterm || otherCtx->lhs.fp == ENT::SPECIALIMPL_COLLECTION_LOGICALAND || otherCtx->lhs.fp == ENT::matchphrase))
                        {
                ...
                else if (n.fp == ENT::logicalor)
                {
                        ...
                        if ((ctx->lhs.fp == ENT::matchterm || ctx->lhs.fp == ENT::matchphrase || ctx->lhs.fp == ENT::SPECIALIMPL_COLLECTION_LOGICALOR) && ctx->rhs.fp == ENT::logicalor && ((otherCtx = (compilation_ctx::binop_ctx *)ctx->rhs.ptr)->lhs.fp == ENT::matchterm || otherCtx->lhs.fp == ENT::SPECIALIMPL_COLLECTION_LOGICALOR || otherCtx->lhs.fp == ENT::matchphrase))
                        {
...
static void expand_node(exec_node &n, compilation_ctx &cctx, simple_allocator &a, std::vector<exec_term_id_t> &terms, std::vector<const compilation_ctx::phrase *> &phrases, std::vector<exec_node> &stack)
{
        ...
        else if (n.fp == ENT::SPECIALIMPL_COLLECTION_LOGICALOR || n.fp == ENT::SPECIALIMPL_COLLECTION_LOGICALAND)
        {
                ...
                do
                {
                        ...
                        {
                                const auto p = (compilation_ctx::phrase *)en.ptr;
                ...
                if (const auto termsCnt = terms.size(), phrasesCnt = phrases.size(); termsCnt == 1)
                {
                        ...
                        else
                        {
                                ...
                                auto phrasesRun = (compilation_ctx::phrasesrun *)cctx.allocator.Alloc(sizeof(compilation_ctx::phrasesrun) + phrasesCnt * sizeof(compilation_ctx::phrase *));
                ...
                {
                        auto run = (compilation_ctx::termsrun *)cctx.runsAllocator.Alloc(sizeof(compilation_ctx::termsrun) + sizeof(exec_term_id_t) * termsCnt);
                        exec_node runNode;
        ...
        {
                const auto p = (compilation_ctx::phrase *)n.ptr;
        ...
        else if (n.fp == ENT::matchsome)
        {
                ...
                else
                {
                        ...
                        else if (ctx->min == ctx->size)
                        {
                                ...
                                {
                                        auto b = (compilation_ctx::binop_ctx *)a.Alloc(sizeof(compilation_ctx::binop_ctx));
        ...
        else if (n.fp == ENT::logicaland || n.fp == ENT::logicalor || n.fp == ENT::logicalnot)
        {
                ...
                if (n.fp == ENT::logicalor)
                {
                        ...
                        else if (ctx->lhs.fp == ENT::matchphrase && ctx->rhs.fp == ENT::matchallterms)
                        {
                                ...
                                const auto *const __restrict__ run = (compilation_ctx::termsrun *)ctx->rhs.ptr;
                                const auto *const phrase = (compilation_ctx::phrase *)ctx->lhs.ptr;
                        ...
                        else if (ctx->lhs.fp == ENT::matchallterms && ctx->rhs.fp == ENT::matchphrase)
                        {
                                ...
                                const auto *const __restrict__ run = (compilation_ctx::termsrun *)ctx->lhs.ptr;
                                const auto *const phrase = (compilation_ctx::phrase *)ctx->rhs.ptr;
...
// TODO: https://github.com/phaistos-networks/Trinity/issues/6
                        ...
                        if (ctx->lhs.fp == ENT::matchterm && ctx->rhs.fp == ENT::matchallphrases)
                        {
                                ...
                                const auto *const __restrict__ run = (compilation_ctx::phrasesrun *)ctx->rhs.ptr;
                ...
                else if (n.fp == ENT::logicalnot)
                {
                        ...
                        if ((ctx->lhs.fp == ENT::matchallterms || ctx->lhs.fp == ENT::matchanyterms) && ctx->rhs.fp == ENT::matchterm)
                        {
                                ...
                                auto run = (compilation_ctx::termsrun *)ctx->lhs.ptr;
                        ...
                        if (ctx->lhs.fp == ENT::matchphrase && ctx->rhs.fp == ENT::matchterm)
                        {
                                ...
                                const auto p = (compilation_ctx::phrase *)ctx->lhs.ptr;
                        ...
                        {
                                auto *const __restrict__ run = (compilation_ctx::phrasesrun *)ctx->lhs.ptr;
        ...
        {
                auto run = (compilation_ctx::termsrun *)n.ptr;
...
void Trinity::group_execnodes(exec_node &n, simple_allocator &a)
{
        if (n.fp == ENT::logicaland)
        {
                ...
                auto g = (compilation_ctx::nodes_group *)a.Alloc(sizeof(compilation_ctx::nodes_group) + sizeof(exec_node) * (r1.size() + r2.size()));
