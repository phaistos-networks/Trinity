...
namespace Trinity {
        ...
        struct query_term_ctx final {
                ...
                struct instance_struct {
                        ...
                        inline range_base<uint16_t, uint8_t> subexpr_range_with_final_index(const uint16_t final_index) const noexcept {
                                return {index, static_cast<uint8_t>(toNextSpan ?: static_cast<uint8_t>(final_index - index))};
                        }

                        struct
                        {
                                // see phrase::rewrite_ctx
        ...
        struct MatchedIndexDocumentsFilter {
                ...
                uint16_t                  query_final_term_index; // may be handy
