...
namespace Trinity {
        namespace DocsSetIterators {
                ...
                // Tpl e two main methods, next() and advance(), are used to access the documents.
		...
		// UPDATE: well, we had to subclass it
                //
                ...
                struct Iterator
                     : public relevant_document_provider {
                      ...
                      public:
                        ...
                        // This is handy, and beats bloating the vtable with e.g a virtual  a virtual ~Iterator(), a virtual cost() etc,
                        // that are only used during engine bootstrap, not runtime execution - or otherwise used rarely
                        const Type type;
