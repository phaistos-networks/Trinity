...
// If this is defined, then Decoder::seek() will consider the skiplist immediately
// before it enters the loop, thereby potentially avoiding any iteration and jumping straight to
// the appropriate block.
// In practice, this only improves AND queries, and even if the number of iterations is dropped by sometimes over 30%
// it appears that, for reasons I need to investigate, avoiding the early skiplist check and instead entering the loop always, is
// somewhat faster.
// TODO: figure this out and enable LUCENE_SKIPLIST_SEEK_EARLY
